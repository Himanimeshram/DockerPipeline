...
def tag="latest"
def dockerHubUser="himanimeshram"
def httpPort="8090"
...
node {
    ...
    stage('Push to Docker Registry'){
        withCredentials([usernamePassword(credentialsId: 'DockerHubCreds', usernameVariable: 'himanimeshram', passwordVariable: 'Password123')]) {
